...
namespace ego_planner
{
  ...
  void EGOReplanFSM::init(ros::NodeHandle &nh)
  {
    ...
    else if (target_type_ == TARGET_TYPE::PRESET_TARGET)
    {
     ...
     //cout<<"66666666666666666666666666666666666"<<endl;
      readGivenWps();
    }
    else
  ...
  void EGOReplanFSM::planNextWaypoint(const Eigen::Vector3d next_wp)
  {
    ...
    if (success)
    {
      ...
      for (int i = 0; i < i_end; i++)
      {
        gloabl_traj[i] = planner_manager_->global_data_.global_traj_.getPos(i * step_size_t);
      }
  ...
  void EGOReplanFSM::execFSMCallback(const ros::TimerEvent &e)
  {
    ...
    case SEQUENTIAL_START: // for swarm
    {
      ...
      if (planner_manager_->pp_.drone_id <= 0 || (planner_manager_->pp_.drone_id >= 1 && have_recv_pre_agent_))
      {
        ...
        {
          bool success = planFromGlobalTrajTraj(10); // zx-todo
          if (success)
          {
  ...
  bool EGOReplanFSM::planFromGlobalTrajTraj(const int trial_times /*=1*/) //zx-todo
  {
    start_pt_ = odom_pos_;
  ...
  bool EGOReplanFSM::planFromGlobalTraj(const int trial_times /*=1*/) //zx-todo
  {
    ...
    for (int i = 0; i < trial_times; i++)
    {
      if (newcallReboundReplan(true, flag_random_poly_init))
      {
        return true;
      }
    }
  ...
  void EGOReplanFSM::checkCollisionCallback(const ros::TimerEvent &e)
  {
    ...
    LocalTrajData *info = &planner_manager_->local_data_;
    auto map = planner_manager_->pos_checker_ptr_;
    ...
    /* ---------- check trajectory ---------- */
    constexpr double time_step = 0.01;//0.01
    ...
    for (double t = t_cur; t < info->duration_; t += time_step)
    {
      ...
      bool occ = false;
      occ |= map->validatePosSurround(info->position_traj_.evaluateDeBoorT(t));
 ...
 ;
    ...
    if (plan_and_refine_success)
    {
      ...
      cout<<"size,size............."<<  bspline.pos_pts.size()<<endl;
  ...
  bool EGOReplanFSM::newcallReboundReplan(bool flag_use_poly_init, bool flag_randomPolyTraj)
  {
  ...
  void EGOReplanFSM::getLocalTarget()
  {
   ...
   ///  cout<<"****t:"<<t<<endl;
    ...
    for (t = planner_manager_->global_data_.last_progress_time_; t < planner_manager_->global_data_.global_duration_; t += t_step)
    {
     ...
     ///cout<<"*************ttttttttttttttttttttttttt:"<<t<<endl;
      Eigen::Vector3d pos_t = planner_manager_->global_data_.getPosition(t);
     
     ///cout<< "***************getPositon=================="<<pos_t <<endl;
     ...
     /// cout<<"**********bugbugbugbug"<<endl;
      ...
      if (dist >= planning_horizen_)
      {
        local_target_pt_ = pos_t;
          ///cout << "local_target_pt_111111=" <<local_target_pt_ << endl;
